...
public class assign extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            String software="";
            pst1 = con1.prepareStatement("Update asset set account=?,user_location=?,handling_user=?, provide_date=?::date, eid=?,comment=?,software=?, availability='assigned' where asset_tag = ? ");
    ...
    int input = JOptionPane.showConfirmDialog(null,"Would you like to assign "+ update.n +" to the user " + ename.getText()+"?", "Assigner",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE);
    if(input==0)
    {
